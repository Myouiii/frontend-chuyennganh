  ...
  return (
    <>
      {carts.length <= 0 && !isOrderSuccess && (
        <Navigate to={constants.ROUTES.CART} />
      )}
      {isAuth ? (
        <div className="main mx-3 sm:mx-auto my-10">
          {isOrderSuccess ? (
            <Result
              status="success"
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col span={24} className="flex items-center">
                <Link to="/">
                  <HomeOutlined
                    className="p-3 icon-home text-[16px] bg-white"
                    style={{ borderRadius: 50 }}
                  />
                </Link>
                <span
                  className="px-2 font-weight-500"
                  style={{ lineHeight: '40px' }}>{`>`}</span>
                <span
                  className="p-2 font-weight-500 bg-white"
                  style={{ borderRadius: 50 }}>
              ...
              <Col span={24} md={16}>
                ...
                {/* ghi chú */}
                <div className="p-4 bg-white rounded-lg min-h-[8rem]">
                  <h2 className="mb-2">Ghi chú cho đơn hàng</h2>
                  <Input.TextArea
                ...
                <div className="p-4 bg-white rounded-lg my-4">
                  ...
                  <p className="mb-3">Thông tin thanh toán của bạn sẽ luôn được bảo mật</p>
                  <Row gutter={[16, 16]}>
                    <Col span={24} md={12}>
                      <div className="py-2 px-4 bg-gray-200/90 item-active">
                    ...
                    <Col
                      ...
                      <div className="py-2 px-4 bg-gray">
                        <b className="text-[16px]">
